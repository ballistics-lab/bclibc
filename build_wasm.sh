...
# Regenerate version.h for every WASM build. A native CMake build may have
# left a generated header from an older checkout, which would otherwise make
# the shipped artifact report that stale version.
