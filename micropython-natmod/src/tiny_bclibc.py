...
def integrate(shot, req):
    return _m.integrate(shot._buf, shot._holder, req._buf, req._traj)


def integrate_at(shot, interp, val):
    return _m.integrate_at(shot._buf, shot._holder, interp, val)


def integrate_stream(shot, req, cb):
    return _m.integrate_stream(shot._buf, shot._holder, req._buf, cb)


def find_zero_angle(shot, dist_ft):
    return _m.find_zero_angle(shot._buf, shot._holder, dist_ft)


def find_apex(shot):
    return _m.find_apex(shot._buf, shot._holder)


def find_max_range(shot, lo, hi):
    return _m.find_max_range(shot._buf, shot._holder, lo, hi)
